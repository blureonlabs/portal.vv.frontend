...
function SalaryRow({ s, canAdmin, setEditingSalary }: { s: Salary; canAdmin: boolean; setEditingSalary: (s: Salary | null) => void }) {
  const qc = useQueryClient()
...
function EditSalaryDialog({ salary, onClose }: { salary: Salary; onClose: () => void }) {
  const qc = useQueryClient()
