    ...
    <div className="bg-white border border-border rounded-xl overflow-hidden">
      ...
      >
        <div className="flex items-center gap-4">
          <div>
            ...
            <p className="text-xs text-muted">{s.period_month} · {SALARY_TYPE_LABELS[s.salary_type_snapshot]}</p>
          </div>
        </div>
        <div className="flex items-center gap-4">
          <p className="text-base font-bold text-primary">{formatAed(s.net_payable_aed)}</p>
          {open ? <span className="material-symbols-rounded text-[16px] text-muted">expand_less</span> : <span className="material-symbols-rounded text-[16px] text-muted">expand_more</span>}
        </div>
      </button>
      ...
      {open && (
        <div className="px-4 pb-4 border-t border-border grid grid-cols-2 md:grid-cols-3 gap-3 pt-3 text-sm">
          ...
          <div className="col-span-2 md:col-span-3 text-xs text-muted mt-1">
